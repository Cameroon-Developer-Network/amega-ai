...
async def chat(
    ...
    return ChatMessage(content=response, timestamp=datetime.utcnow(), user_id=current_user.username)
...
async def health_check():
    ...
    return {"status": "healthy", "timestamp": datetime.utcnow(), "version": settings.APP_VERSION}
