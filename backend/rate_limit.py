...
class RateLimiter:
    ...
    def __init__(
        self, redis_url: str = "redis://localhost:6379", default_limits: Optional[dict] = None
    ):
    ...
    async def is_rate_limited(self, identifier: str, tier: str = "default") -> Tuple[bool, dict]:
        """
